...
3. Add the upstream remote:
   ```bash
   git remote add upstream https://github.com/datvietvac-techhub/manifestor.git
   ```
...
1. Check existing [issues](https://github.com/datvietvac-techhub/manifestor/issues) to avoid duplicates.
...
1. Open a [feature request issue](https://github.com/datvietvac-techhub/manifestor/issues/new?template=feature_request.md) first to discuss the design.
